...
EXCEL_FILE = BASE_DIR / "data" / "onet" / "Occupation Data.xlsx"  
# ---------- Read Excel ----------
...
# ---------- Clean ----------
df = df.dropna(subset=["onet_soc", "title"])
...
print(" Occupation data inserted successfully into MongoDB:", collection.name)
