...
db = client["jobdb"]
collection = db["work_activities"]

# ---------- Path ----------

BASE_DIR = Path(__file__).resolve().parent.parent   
EXCEL_FILE = BASE_DIR / "data" / "onet" / "Work Activities.xlsx"  
...
print("Work Activities inserted successfully into MongoDB:", collection.name)
